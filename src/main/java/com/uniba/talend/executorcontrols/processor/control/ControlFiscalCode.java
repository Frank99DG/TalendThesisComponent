...
public class ControlFiscalCode {
    ...
    public ControlFiscalCode(String column, List<Record> recordList, List<Schema.Entry> schemaList){
    ...
    public void resultControl(){
        ...
        if(type.toString().matches("STRING") || type.toString().matches("String")  ) {
            System.out.println("**** Codici Fiscali errati "+"nella colonna "+column+" **** \n");
            for (int i = 0; i < recordList.size(); i++) {
                String p = "ciao";
            ...
            System.out.println("il campo "+column+" non contiene codici fiscali validi "+"\n");
        }
